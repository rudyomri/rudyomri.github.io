L.Control.Measure = L.Control.extend({
	...
	_updateTooltipDistance: function(total, difference) {
		...
		var totalRoundKm = totalRound * 1.852;
		var diffRoundKm = differenceRound * 1.852;
		
		var totalRoundKmDec = Math.round(totalRoundKm * 100) / 100 ;
		var diffRoundKmDec = Math.round(diffRoundKm * 100) / 100 ;

		var text = '<div class="leaflet-measure-tooltip-total">' + totalRoundKmDec + ' km</div>';
		if(differenceRound > 0 && totalRound != differenceRound) {
			text += '<div class="leaflet-measure-tooltip-difference">(+' + diffRoundKmDec + ' km)</div>';
		}
